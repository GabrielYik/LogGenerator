...
|
* descriptions
** An array of non-empty strings, with each string representing a description

|Types
|The range of values the type attribute of a log in the group can take.
|
* types
** An array of non-empty strings, with each string representing a type
...
|
* remarks
** An array of non-empty strings, with each string representing a remark
